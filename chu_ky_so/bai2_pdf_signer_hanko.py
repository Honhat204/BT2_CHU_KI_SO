...
# === ĐƯỜNG DẪN (dùng raw string để tránh lỗi escape) ===
BASE_DIR = r"D:\chu_ky_so"
PDF_IN = os.path.join(BASE_DIR, "btvn2_baomat_fixed.pdf")
PDF_OUT = os.path.join(BASE_DIR, "btvn2_baomat_signed.pdf")
KEY_FILE = os.path.join(BASE_DIR, "signer_key.pem")
CERT_FILE = os.path.join(BASE_DIR, "signer_cert.pem")
SIG_IMG = os.path.join(BASE_DIR, "chu_ky.png")  # Ảnh chữ ký "bóng"
